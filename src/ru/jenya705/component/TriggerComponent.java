...
public class TriggerComponent extends Component{
	...
	public void registerComponent() {
		Component.addComponent("trigger", this);
		addFunction("players", TriggerComponent::countPlayersEnteredTrigger);
		addFunction("getplayers", TriggerComponent::playersEnteredTrigger);
	...
	public static void setTriggers(List<Trigger> triggers) {
		TriggerComponent.triggers = triggers;
	}
